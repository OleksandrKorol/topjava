...
@NamedQueries({
        ...
        @NamedQuery(name = User.ENABLE_DISABLE, query = "UPDATE User u SET u.enabled= :enabled WHERE u.id= :id"),
})
@Entity
...
//    public static final String GRAPH_WITH_MEALS = "User.withMeals";
    ...
    public static final String ENABLE_DISABLE = "User.enableOrDisable";
